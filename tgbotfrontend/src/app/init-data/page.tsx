...
export default function InitDataPage() {
  ...
  useEffect(() => {
    ...
    let referralType = null as any
    let referralId = null as any

    // if(launchParams.startParam) {
    //   const { type, id } = JSON.parse(atob(launchParams?.startParam))
    //   if(type && id) {
    //     referralType = type
    //     referralId = id
    //   }
    ...
    fetch("https://c4qtm-7qaaa-aaaak-akwoq-cai.raw.icp0.io/bot/login", {
      headers: {
  ...
  }, [initData, initDataRaw, launchParams])
